...
extension DetailsLeagueController : UICollectionViewDelegate , UICollectionViewDelegateFlowLayout , UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if(spLabel == 3){
            ...
            cell.teamName.text = teams?[indexPath.row].players[indexPath.row].player_name
        
            cell.teamImg.kf.setImage(with: URL(string: teams?[indexPath.row].players[indexPath.row].player_image ?? "No image"), placeholder: UIImage(named: "real.png"), options: [.keepCurrentImageWhileLoading], progressBlock: nil, completionHandler: nil)
...
//         }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if(collectionView == teamCollection){
            ...
            TeamViewControllerObj.team = teams![indexPath.row]
            TeamViewControllerObj.coach = teams![indexPath.row].coaches[0].coach_name ?? "unKnown"
    ...
    func workWithDispatchQueue () {
        ...
        self.networkfromteams.fetchTeam(url: "https://apiv2.allsportsapi.com/football/?met=Teams&?met=Leagues&leagueId=3&APIkey=59dbd205f73cf075a8012c155eec9c37aa90478a4538caf0066c651dc62bb9b8") { result in
